...
Первый экран оформлен по предоставленному образцу: заголовок «Аким на 5 часов», панорама города и исходные показатели **52.56 / 100**, **100 ед.** и **5 районов**. Ниже расположен конструктор с открытыми настройками режима и вкладками «Планирование», «Карта Астаны», «Результаты». В основном режиме каталог из 14 мероприятий сразу виден рядом с планом из пяти слотов. Интерактивная карта остается ситуационным центром на отдельной вкладке. Внутренние суммы и JSON сохраняют прежний формат в тенге.
...
Первый экран показывает базовый Score **52.56**, **100 ед.** и пять районов. HUD конструктора обновляется вместе с планом. Карточки районов находятся под картой; «Управлять» выбирает район и открывает вкладку планирования. Кнопка «Открыть каталог мероприятий» в панели карты ведет туда же. «Сбросить сценарий» очищает планы, AI-отчёты и историю игровых уведомлений.
